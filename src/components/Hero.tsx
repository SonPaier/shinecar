  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center bg-gradient-hero overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={heroImage}
          alt="Luxury car detailing Łuków"
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="min-h-screen flex items-center py-24">
          <div className="max-w-3xl space-y-10">
            ...
            <h1 className="font-luxury text-5xl sm:text-6xl lg:text-7xl leading-[1.1] text-foreground">
              <AnimatedP>ShineCar</AnimatedP>
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl">
              <AnimatedP>Detailing klasy premium Łuków – Bezbarwne Folie Ochronne PPF, Kolorowe Folie Ochronne PPF, Korekta Lakieru, Powłoki i Detaling Wnętrz.</AnimatedP>
            </p>
            <div className="flex flex-col sm:flex-row gap-5 pt-2">
              ...
              <Button variant="ghost" size="lg" className="text-foreground/80 transition-colors duration-200 hover:bg-deep-black/5 hover:text-primary hover:font-semibold" onClick={() => {
                const location = window.location.pathname;
                if (location !== '/') {
